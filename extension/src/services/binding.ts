    ...
    constructor(video: HTMLMediaElement, hasPageScript: boolean, frameId?: string) {
        ...
        this.saviGlossHover = new SaviGlossHover({
            ...
            onReveal: (lineText, word, gloss) => {
                ...
                // being studied (SV-21). A hover held still emits no further
                // DOM events, so without this an actively-studied line would
                // age into "idle" while the user stares right at it.
